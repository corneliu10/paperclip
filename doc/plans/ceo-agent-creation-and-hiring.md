...
- installed adapter list for this BirdAI instance
...
## 8. New Skill: `birdai-create-agent`

Create new skill directory:

- `skills/birdai-create-agent/SKILL.md`
...
Also update `skills/birdai/SKILL.md` to reference this skill for hiring workflows.
...
- `birdai-create-agent` skill + docs updates
