# BirdAI API Reference

Detailed reference for the BirdAI control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "BirdAI Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "birdai-mobile",
    "cwd": "/Users/me/birdai-mobile",
    "repoUrl": "https://github.com/acme/birdai-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `birdai-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
