...
This document describes how `@birdai/adapter-openclaw-gateway` invokes OpenClaw over the Gateway protocol.
...
5. stream `event agent` frames into BirdAI logs/transcript parsing
