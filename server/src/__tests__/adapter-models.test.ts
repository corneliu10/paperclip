...
import { models as codexFallbackModels } from "@birdai/adapter-codex-local";
import { models as cursorFallbackModels } from "@birdai/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@birdai/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.BIRDAI_OPENCODE_COMMAND;
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.BIRDAI_OPENCODE_COMMAND = "__birdai_missing_opencode_command__";
