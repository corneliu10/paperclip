...
import { companySecrets, companySecretVersions } from "@birdai/db";
import type { AgentEnvConfig, EnvBinding, SecretProvider } from "@birdai/shared";
import { envBindingSchema } from "@birdai/shared";
