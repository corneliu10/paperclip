...
BirdAI organizes autonomous AI work around five key concepts.
...
One BirdAI instance can run multiple companies.
...
Agents don't run continuously. They wake up in **heartbeats** — short execution windows triggered by BirdAI.
