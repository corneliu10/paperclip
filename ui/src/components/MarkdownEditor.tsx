...
import { buildProjectMentionHref, parseProjectMentionHref } from "@birdai/shared";
...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
    ...
    for (const node of links) {
      ...
      if (!parsed) {
        if (link.dataset.projectMention === "true") {
          ...
          link.classList.remove("birdai-project-mention-chip");
      ...
      link.classList.add("birdai-project-mention-chip");
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative birdai-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("birdai-mdxeditor", !bordered && "birdai-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "birdai-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
